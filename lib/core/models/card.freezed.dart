...
mixin _$Card {
  ...
  CardFlag get cardFlag => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      cardModel: null == cardModel
          ...
          : cardModel // ignore: cast_nullable_to_non_nullable
              as CardModel,
      cardFlag: null == cardFlag
          ? _value.cardFlag
          : cardFlag // ignore: cast_nullable_to_non_nullable
              as CardFlag,
    ) as $Val);
  }
}
...
class _$CardImpl with DiagnosticableTreeMixin implements _Card {
  ...
  @override
  final CardFlag cardFlag;

  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Card(number: $number, ownerName: $ownerName, cardModel: $cardModel, cardFlag: $cardFlag)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('cardFlag', cardFlag));
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.cardFlag, cardFlag) ||
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, number, ownerName, cardModel, cardFlag);
...
abstract class _Card implements Card {
  const factory _Card(
      ...
      required final CardFlag cardFlag}) = _$CardImpl;
